...
INSERT INTO `recipient` (`OrderID`, `RecipientName`, `RecipientPhone`, `RecipientCountry`, `RecipientCity`, `RecipientDistrict`, `RecipientAddress`, `RecipientPostalCode`) VALUES ('1', 'james', '0958222222', 'Taiwan', 'Taipei', '文山區', '興隆路二段', '11603'), ('2', 'Gato', '0933221003', 'Taiwan', 'Taichung', '南屯區', '文心南路192號', '19933');-- INSERT INTO `Brand` (BrandName, Description) VALUES ("DC", "Skate shoes & sneakers by DC Shoes stand for high quality and innovation. Founded by Ken Block, DC Shoes is sitting pretty atop the skate scene and are excited about their top-notch skate team. In addition to skate shoes, DC Shoes also offers you high-quality streetwear and accessories.");
