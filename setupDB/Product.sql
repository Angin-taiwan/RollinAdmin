...
-- ALTER TABLE `product` ADD CONSTRAINT `FK_Product_Brand` FOREIGN KEY (`BrandID`) REFERENCES `Rollin`.`Brand` (`BrandID`),
--                           CONSTRAINT `FK_Product_Category` FOREIGN KEY (`CategoryID`) REFERENCES `Rollin`.`Category` (`CategoryID`) ;
